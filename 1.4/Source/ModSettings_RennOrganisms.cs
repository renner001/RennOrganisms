...
namespace DanielRenner.RennOrganisms
{
    ...
    {
        public static int moodMultipilerSettingsPercent = 100;

        public static void DoSettingsWindowContents(Rect rect)
        {
            Rect descriptionRect = rect.TopPartPixels(Text.CalcHeight(Translations_RennOrganisms.Static.SettingsPanelChangeSettingsEffect, rect.width));
            Rect mainRect = rect.BottomPartPixels(rect.height - descriptionRect.height - 50);
            Widgets.Label(descriptionRect, Translations_RennOrganisms.Static.SettingsPanelChangeSettingsEffect);
            ...
            LabeledScrollbar(listMain, "Adapt Mood Effects (%)", ref ModSettings_RennOrganisms.moodMultipilerSettingsPercent, "Change the mood effects that this mod applies to your colonists. 50% would mean, that a normally applied mood effect of -10 mood would turn into a -5 mood effect.");
            listMain.End();
        ...
        public override void ExposeData()
        {
            ...
            // all scribes...
            Scribe_Values.Look(ref moodMultipilerSettingsPercent, "moodMultipilerSettingsPercent", 100);
